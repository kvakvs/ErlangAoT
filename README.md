...
Phases I–III and step 10 of the [parser plan](.agents/02-parser.md) are implemented as a native
...
and receive expressions with optional timeouts. Other syntax remains explicitly
