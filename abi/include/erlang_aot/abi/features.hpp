...
inline constexpr std::array feature_catalog{
    ...
    FeatureInfo{FeatureId::term_services, "term services", FeatureOwner::runtime, "TermFactory/Term accessors",
                FeatureStatus::deferred, 10, "runtime_features"},
    FeatureInfo{FeatureId::builtins, "builtins", FeatureOwner::runtime, "native callable invocation",
                FeatureStatus::deferred, 11, "runtime_features"},
    FeatureInfo{FeatureId::process_execution, "process execution", FeatureOwner::runtime, "ProcessCode::resume",
                FeatureStatus::deferred, 13, "runtime_features"},
    FeatureInfo{FeatureId::message_passing, "message passing", FeatureOwner::runtime, "ProcessContext::send",
                FeatureStatus::deferred, 13, "runtime_features"},
    FeatureInfo{FeatureId::scheduling, "scheduling", FeatureOwner::runtime, "SchedulerPool worker execution",
                FeatureStatus::deferred, 13, "runtime_features"},
    FeatureInfo{FeatureId::allocation, "allocation", FeatureOwner::runtime, "ProcessHeap::allocate",
                FeatureStatus::deferred, 12, "runtime_features"},
    ...
    FeatureInfo{FeatureId::dynamic_modules, "dynamic modules", FeatureOwner::runtime, "CodeServer::load/unload",
                FeatureStatus::deferred, 14, "runtime_features"},
