...
enum class TokenKind : std::uint8_t { atom, variable, integer, floating, character, string,
...
struct Token {
    ...
    // Later expansion/include stages can attach origins without rewriting spelling.
